...
serper_api_key = os.getenv("GROQ_API_KEY")

#Função para chamar o modelo
response = completion(
    model="groq/llama3-8b-8192",
    messages=[
        {"role": "user", "content": "Responda em português: Olá, como você pode me ajudar?"}
    ]
)
print(response)
...
market_researcher = Agent(
	...
	role="Pesquisador de Mercado de Vinho e Sommelier Sênior",
	goal="Garanta que o negócio {ideia} seja respaldado por pesquisas e dados sólidos comparando com o que já existe no mercado. \n "
		 "Realize uma pesquisa abrangente e realista para a ideia de negócio para abrir uma loja de vinho",
	backstory="Você é um especialista de mercado habilitado para pesquisas de mercado e muito \n"
			  "habilidoso em validar ideias de negócios. Você trabalhou com várias empresas estabelecidas de vinho."
              "Trabalho em vinicolas, é sommelier de vinho há muitos anos, e estudou bem o mercado onde vai atuar" ,
...
enterpreneur_agent = Agent(
	...
	goal="Criar um estratégia de marketind um plano de negócios para {ideia}",
	backstory="Você já construiu anteriormente uma empresa de sucesso. "
			  "Você tem habilidade de criar novas ideias de negócios e de planos de marketing." ,
	allow_delegation=False,
	verbose=True,
	llm="groq/llama3-8b-8192"
)
...
task_market_researcher = Task(
	description="Analisar quais as melhores estratégias e possíveis ameaças ao negócio {ideia}. \n"
				...
				"Força insigts para a criação do plano de negócios", #tarefa a ser realizada
	expected_output=(
